                      ...
                      <form action=""method="POST">
                        ...
                        <div class="form-group pt-2">
                          ...
                          <div class="password-container">
                            <input type="password" id="password" name="password" style="width:100%;height:3em;"placeholder="Password" required>
                        ...
                        <div class="form-group pt-2">
                          <button type="submit"id="loginbtn" name="LoginBtn" class="btn btn-info btn-rounded text-light pt-2 pb-2 pl-4 pr-4">Sign In</button>
                        </div>
                      </form>
                    </div>
                </div>
